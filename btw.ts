...
import { buildBudgetedMessages, type BudgetOptions } from "./btw-context-budget.js";
...
function buildBtwMessages(ctx: ExtensionContext, userMessage: UserMessage, systemPrompt: string): Message[] {
	...
	// Context window budgeting (fix: model_context_window_exceeded)
...
export async function executeBtw(
	...
	const messages = buildBtwMessages(ctx, userMessage, systemPrompt);
